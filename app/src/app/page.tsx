...
// Full-width chromatic sections, medium density
// ============================================================
...
export default function HomePage() {
  return (
    <main className="w-full">
      ...
      {/* BIOSYNTAR SECTION */}
      {/* ===================================================== */}
      <section className="w-full bg-emerald-100/80">
        <div className="mx-auto max-w-6xl px-6 py-24">
          <div className="max-w-3xl">
            ...
            <p className="mt-4 text-[11px] uppercase tracking-widest text-emerald-700">
              Problem domain: food-contact surface contamination
            </p>

            <p className="mt-8 text-base leading-relaxed text-neutral-900">
      ...
      {/* POLYVERDIA SECTION */}
      {/* ===================================================== */}
      <section className="w-full bg-sky-100/80">
        <div className="mx-auto max-w-6xl px-6 py-24">
          <div className="max-w-3xl">
            ...
            <p className="mt-4 text-[11px] uppercase tracking-widest text-sky-700">
      ...
      <section className="mx-auto max-w-6xl px-6 py-16">
        <footer className="max-w-3xl border-t border-neutral-300 pt-8">
