    ...
    <main className="global-gpi-poster">
      ...
      <section className="materials-panel" aria-label="Sustainable materials">
        <div className="materials-header">
          <div className="materials-icon" aria-hidden="true">◌</div>
        ...
        <a className="material-card" href="/materials/biosyntar">
          ...
          <div>
            <h3>BioSyntar</h3>
            <p>Biodegradable antibacterial microfilms for food safety and food-contact packaging.</p>
          </div>
        </a>
        ...
        <a className="material-card" href="/materials/polyverdia">
          ...
          <div>
            <h3>PolyVerdia</h3>
            <p>Moisture-active protection for HVAC systems. Helps reduce microbial growth where it starts.</p>
          </div>
        </a>
        ...
        <a className="material-card" href="/materials/single-use-plastics">
          ...
          <div>
            ...
            <p>Designed for performance in use and rapid end-of-life. Biodegradable or recyclable solutions.</p>
          </div>
        </a>
        ...
        <a className="material-card phantom-card" href="https://neuroviaapplieddefense.com/">
          ...
          <div>
            <h3>PhantomFiber™</h3>
            <p>Proprietary platform technology that delivers embedded antibacterial performance at the material level.</p>
          </div>
        </a>
      </section>

      <div className="earth-video-wrap" aria-hidden="true">
        <video ref={videoRef} className="earth-video" autoPlay muted loop playsInline>
      ...
      <section className="ai-panel" aria-label="AI systems">
        <div className="ai-header">
          ...
          <h2>AI SYSTEMS<span>Powered by Moral Clarity</span></h2>
          <p>Execution-time AI. Controlled. Trusted. Accountable.</p>
        </div>

        <a className="ai-card" href="https://www.solacemed.ai">
          <img src="/images/solacemed_hero.png" alt="SolaceMed" className="ai-card-image" />
          <div>
            <h3>SolaceMed</h3>
            <p>Intelligent systems for healthcare operations, compliance, and patient outcomes.</p>
          </div>
        </a>

        <a className="ai-card" href="https://www.solacelegal.ai">
          <img src="/images/solacelegal_hero.png" alt="SolaceLegal" className="ai-card-image" />
          <div>
            <h3>SolaceLegal</h3>
            <p>AI systems for legal workflows, research, compliance, and document intelligence.</p>
          </div>
        </a>

        <a className="ai-card" href="https://www.solacetrade.ai">
          <img src="/images/solacetrade_hero.png" alt="SolaceTrade" className="ai-card-image" />
          <div>
            <h3>SolaceTrade</h3>
            <p>AI solutions for trade intelligence, risk analysis, valuation, and commercial operations.</p>
          </div>
        </a>
        ...
        <div className="governance-card">
          ...
          <div>
            ...
            <p>Not what AI recommends — what AI is allowed to do. Ethical. Transparent. Aligned.</p>
          </div>
        </div>
      </section>
